...
export default function Home() {
  const features = [
    {
      icon: <BiDonateHeart className="w-8 h-8 text-primary" />,
    ...
    {
      icon: <MdVerified className="w-8 h-8 text-primary" />,
    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Why Choose FeedAll?</h2>
